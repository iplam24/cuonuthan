<template>
  <div>
    ...
    >
      <div
        v-if="isOpen"
        class="absolute right-0 top-full mt-3 w-[calc(100vw-2rem)] sm:w-96 max-w-sm rounded-3xl bg-white border border-slate-200/80 shadow-2xl z-50 overflow-hidden"
        @click.stop
      >
